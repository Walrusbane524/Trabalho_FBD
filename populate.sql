...
VALUES
  (1, 'debito', 19.99, '2023-05-01', '2023-05-10', 1),
  (2, 'credito', 24.99, '2023-05-02', '2023-05-12', 2),
  (3, 'dinheiro', 29.99, '2023-05-03', '2023-05-14', 3),
  (4, 'debito', 21.99, '2023-05-04', '2023-05-16', 4),
  (5, 'credito', 26.99, '2023-05-05', '2023-05-18', 5),
  (6, 'dinheiro', 31.99, '2023-05-06', '2023-05-20', 6),
  (7, 'debito', 23.99, '2023-05-07', '2023-05-22', 7),
  (8, 'credito', 28.99, '2023-05-08', '2023-05-24', 8),
  (9, 'dinheiro', 33.99, '2023-05-09', '2023-05-26', 9),
  (10, 'debito', 25.99, '2023-05-10', '2023-05-28', 10);
